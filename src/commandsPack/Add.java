 ...
 */
public class Add extends Show implements commandInterfacePack.Add {
    protected Add() {}
    ...
    public void add() {
        ...
        collection.addElement(new Coordinates(x, y), genre, mpaaRating, movieName, operator, oscarsCount);
